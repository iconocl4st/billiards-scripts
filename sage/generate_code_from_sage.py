...
class State:
    ...
    def print(self, last_var, num):
        print('[[nodiscard]] inline')
        print('bool get_solution_' + str(num).zfill(3) + '(')
        for arg in self.args:
            print('\t\tconst double ' + arg + ',')
        print('\t\tdouble *out_param')
        print(') {')
        for cmd in self.commands:
            print(cmd)
        print('\t*out_param = ' + last_var + ';')
        print('\treturn true')
        print('}')
